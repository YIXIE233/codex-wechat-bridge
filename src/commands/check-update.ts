...
async function main(): Promise<void> {
  ...
  console.log(`Codex WeChat Bridge Version Check`);
  ...
  if (!versionInfo) {
    ...
    console.error(
      `Could not read the latest codex-wechat-bridge version from the npm registry or GitHub.`,
    );
    ...
    console.error(
      `  https://github.com/YIXIE233/codex-wechat-bridge/releases`,
    );
  ...
  console.log(`   cd codex-wechat-bridge`);
  console.log(`   git pull`);
  console.log(`   npm install -g .\n`);

  console.log(`For more information:`);
  console.log(`   https://github.com/YIXIE233/codex-wechat-bridge/releases`);
}
